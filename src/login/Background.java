...
import static com.twelvemonkeys.image.ImageUtil.blur;
...
import style.FancyBorderRadius;
...
public class Background extends JComponent {
    ...
    private void createBlurImage(Graphics2D g3){
        int x = blur.getX();
        int y = blur.getY();
        ...
        if (width > 0 && height > 0) {
            ...
            g2.fill(shape);
            g2.dispose();
            g3.drawImage(new ShadowRenderer(shadow, 0.3f, new Color(0, 0, 0)).createShadow(img), (int) (x - shadow * 0.8f), (int) (y - shadow * 0.8f), null);
            g3.drawImage(img, x, y, null);       
        }
    }
